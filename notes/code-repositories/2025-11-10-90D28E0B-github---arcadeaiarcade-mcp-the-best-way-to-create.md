---
title: "GitHub - ArcadeAI/arcade-mcp: The best way to create, deploy, and share MCP Servers"
url: https://github.com/ArcadeAI/arcade-mcp
tags: [code, github]
category: Code Repository
date: 2025-11-10
id: 90D28E0B-EEC5-4F64-9B52-4A19A9A96BD8
created: 2025-11-10T11:16:24Z
modified: 2025-11-10T11:16:24Z
---
# GitHub - ArcadeAI/arcade-mcp: The best way to create, deploy, and share MCP Servers

## Summary

The best way to create, deploy, and share MCP Servers - ArcadeAI/arcade-mcp. Simple local development (literally uv run server.py). Production-grade security. No architectural rewrites when you scale. It's the MCP framework that grows with you—from first prototype to enterprise deployment.

**Category:** `Code Repository`  

**Tags:** `code` `github`

**Source:** [https://github.com/ArcadeAI/arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)
...
Topics: agent, ai, arcade, arcade-ai, artificial-intelligence, langchain, langgraph, llm, llm-tool-call, llm-tools, mcp, mcp-client, mcp-servers, mcp-tools, openai, toolcalling
