---
title: "GitHub - SAP-samples/sap-rpt-1-oss: Implementation of the sap-rpt-1-oss deep learning model with inf"
url: https://github.com/SAP-samples/sap-rpt-1-oss/tree/main
tags: [development, documentation, ai, research, academic, tutorial, machine-learning, code]
category: Code Repository
date: 2025-11-04
id: 4CE15FD9-8BF9-487C-BDF1-C1F4336A5F1B
created: 2025-11-04T22:13:59Z
modified: 2025-11-04T22:13:59Z
---
# GitHub - SAP-samples/sap-rpt-1-oss: Implementation of the sap-rpt-1-oss deep learning model with inf
...
**Source:** [https://github.com/SAP-samples/sap-rpt-1-oss/tree/main](https://github.com/SAP-samples/sap-rpt-1-oss/tree/main)

---

## Content

Repository: SAP-samples/sap-rpt-1-oss
Description: Implementation of the sap-rpt-1-oss deep learning model with inference pipeline as described in the paper "ConTextTab: A Semantics-Aware Tabular In-Context Learner".

Topics: conference, deep-learning, foundation-model, machine-learning, research, tabular
