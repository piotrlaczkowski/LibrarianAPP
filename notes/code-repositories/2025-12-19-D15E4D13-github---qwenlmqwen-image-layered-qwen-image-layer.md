---
title: "GitHub - QwenLM/Qwen-Image-Layered: Qwen-Image-Layered: Layered Decomposition for Inherent Editablity"
url: https://github.com/QwenLM/Qwen-Image-Layered
tags: [code, github]
category: Code Repository
date: 2025-12-19
id: D15E4D13-323E-466D-B08F-957603E110CD
created: 2025-12-19T16:44:36Z
modified: 2025-12-19T16:44:36Z
---
# GitHub - QwenLM/Qwen-Image-Layered: Qwen-Image-Layered: Layered Decomposition for Inherent Editablity

## Summary

Qwen-Image-Layered, a model capable of decomposing an image into multiple RGBA layers. This layered representation unlocks inherent editability: each layer can be independently manipulated without affecting other content. Meanwhile, such a layered representation naturally supports high-fidelity elementary operations-such as resizing, reposition, and recoloring. By physically isolating semantic or structural components into distinct layers, our approach enables high-fidelity and consistent editing.
...
Explicitly specify 3–10 layers — from coarse layouts to fine-grained details
✅ Infinite decomposition
Keep drilling down: layers within layers, to any depth of detail

🤗 Hugging Face: https://lnkd.in/gk7WwiNy
🧩 ModelScope: https://lnkd.in/ggX-8MC5
💻 GitHub: https://lnkd.in/gnCBXC5Q
📝 Blog: https://lnkd.in/gtqhXhZC
📄 Technical Report: https://lnkd.in/gwneZ68C
🚀 Demo (HF): https://lnkd.in/g6BFvQts
🚀 Demo (ModelScope): https://lnkd.in/grfDPTjM

**Category:** `Code Repository`  

**Tags:** `code` `github`

**Source:** [https://github.com/QwenLM/Qwen-Image-Layered](https://github.com/QwenLM/Qwen-Image-Layered)

---

## Content

Repository: QwenLM/Qwen-Image-Layered
